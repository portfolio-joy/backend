...
public class UserController {
	...
	public ResponseEntity<Skill> updateSkill(@RequestParam String id, @RequestBody @Valid SkillDto skillDto)
	{
		return ResponseEntity.status(HttpStatus.CREATED).body(userService.updateSkill(id,skillDto));
	}
	
	@DeleteMapping(value="/skill")
	public ResponseEntity<Skill> removeSkill(@RequestParam String id)
	{
